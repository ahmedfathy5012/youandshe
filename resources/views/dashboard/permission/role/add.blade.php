...
{{--                        <form method="POST" class="row" enctype="multipart/form-data" id="SubmitForm" action="{{route('add_role')}}">--}}
                        <form id="SubmitForm">
                            @csrf
...
{{--                            @endfor--}}
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <input type="text" class="form-control" id="name" name= "name" placeholder="الاسم"
                                       value="{{!is_null($role??null)? $role->name:old('name')}}">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <input type="text" class="form-control" id="display_name" name= "display_name" placeholder="الاسم"
                                       value="{{!is_null($role??null)? $role->display_name:old('display_name')}}">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <input type="text" class="form-control" id="description" name= "description" placeholder="الوصف"
                                       value="{{!is_null($role??null)? $role->description:old('description')}}">
