        ...
        <div class="card card-custom">
            <div class="card-header flex-wrap py-5">
                <div class="card-toolbar">
                    <!--begin::Button-->
                    <a href="{{route('add_package_form')}}" class="btn btn-primary font-weight-bolder" >
            ...
            <div class="card-body">
                <table class="table table-responsive-sm" id="table">
                    ...
                    @for ($i = 0; $i < count($packages); $i++)
                        <tr>
                            <th scope="row">{{$packages[$i]->id??''}}</th>
                            <td>{{$packages[$i]->name??''}}</td>
                            <td>
                                <a href="{{route('edite_package_form',['id' => $packages[$i]->id])}}" class="btn btn-icon btn-light btn-hover-primary btn-sm mx-3" id="editState">
                                    <i class="fas fa-edit text-primary"></i>
                                </a>
                                <a href="{{route('delete_package',['id' => $packages[$i]->id])}}" class="btn btn-icon btn-light btn-hover-danger btn-sm" id="deleteState" type="click">
