...
{{--                        <th scope="col">Action</th>--}}
                    ...
                    @for ($i = 0; $i < count($barbers); $i++)
                        <tr>
                            <th scope="row">{{$barbers[$i]->id??''}}</th>
                            <td>{{$barbers[$i]->name??''}}</td>
                            <td>{{$barbers[$i]->phone??''}}</td>
{{--                            <td>--}}
{{--                                <a href="{{route('edite_user_form',['id' => $barbers[$i]->id])}}" class="btn btn-icon btn-light btn-hover-primary btn-sm mx-3" id="editState">--}}
