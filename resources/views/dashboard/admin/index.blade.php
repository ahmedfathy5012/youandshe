        ...
        <div class="card card-custom">
            <div class="card-header flex-wrap py-5">
                <div class="card-toolbar">
                    <!--begin::Button-->
                    <a href="{{route('add_admin_form')}}" class="btn btn-primary font-weight-bolder" >
                ...
                <table class="table table-responsive-sm" id="table">
                    ...
                    @for ($i = 0; $i < count($admins); $i++)
                        <tr>
                            ...
                            <td>
                                <a href="{{route('edite_admin_form',['id' => $admins[$i]->id])}}" class="btn btn-icon btn-light btn-hover-primary btn-sm mx-3" id="editState">
                                    <i class="fas fa-edit text-primary"></i>
                                </a>
                                <a href="{{route('delete_admin',['id' => $admins[$i]->id])}}" class="btn btn-icon btn-light btn-hover-danger btn-sm" id="deleteState" type="click">
