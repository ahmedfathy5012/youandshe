        ...
        <div class="card card-custom">
            <div class="card-header flex-wrap py-5">
                <div class="card-toolbar">
                    <!--begin::Button-->
                    <a href="{{route('add_service_form')}}" class="btn btn-primary font-weight-bolder" >
            ...
            <div class="card-body">
                <table class="table table-responsive-sm" id="table">
                    ...
                    @for ($i = 0; $i < count($services); $i++)
                        <tr>
                            <th scope="row">{{$services[$i]->id??''}}</th>

                            <td>
                                <img src="{{asset($services[$i]->getIcon())}}" style="width:50px;height: 50px;border-radius: 10px" />
                            </td>

                            <td>{{$services[$i]->name??''}}</td>
                            <td>
                                <a href="{{route('edite_service_form',['id' => $services[$i]->id])}}" class="btn btn-icon btn-light btn-hover-primary btn-sm mx-3" id="editState">
                                    <i class="fas fa-edit text-primary"></i>
                                </a>
                                <a href="{{route('delete_service',['id' => $services[$i]->id])}}" class="btn btn-icon btn-light btn-hover-danger btn-sm" id="deleteState" type="click">
