        ...
        <div class="card card-custom">
            <div class="card-header flex-wrap py-5">
                <div class="card-toolbar">
                    <!--begin::Button-->
                    <a href="{{route('add_state_form')}}" class="btn btn-primary font-weight-bolder" >
            ...
            <div class="card-body">
                <table class="table table-responsive-sm" id="table">
                    ...
                    @for ($i = 0; $i < count($states); $i++)
                        <tr>
                            <th scope="row">{{$states[$i]->id??''}}</th>
                            <td>{{$states[$i]->title??''}}</td>
                            <td>
                                <a href="{{route('edite_state_form',['id' => $states[$i]->id])}}" class="btn btn-icon btn-light btn-hover-primary btn-sm mx-3" id="editState">
                                    <i class="fas fa-edit text-primary"></i>
                                </a>
                                <a href="{{route('delete_state',['id' => $states[$i]->id])}}" class="btn btn-icon btn-light btn-hover-danger btn-sm" id="deleteState" type="click">
